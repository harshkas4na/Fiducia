          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="w-40 bg-transparent border-2 border-green-400 text-green-400 font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 text-sm relative overflow-hidden group"
              >
