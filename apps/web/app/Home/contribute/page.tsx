    ...
    <div className="h-full w-full relative">
      ...
      <div className="relative z-10 gap-24 h-full flex flex-col">
        ...
        <div className="flex-grow flex flex-col lg:flex-row justify-start items-start gap-6 gap-x-80">
          <div className="backdrop-blur-md bg-gray-800 bg-opacity-50 p-6 ml-2 rounded-3xl shadow-lg w-full lg:w-1/2">
          ...
          <div className="backdrop-blur-md bg-gray-800 bg-opacity-50 p-6 mr-2 rounded-3xl shadow-lg w-full lg:w-1/3">
            <h2 className="text-2xl font-semibold mb-4 text-blue-300">
